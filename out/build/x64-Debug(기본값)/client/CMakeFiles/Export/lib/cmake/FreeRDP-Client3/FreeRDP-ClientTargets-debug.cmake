...
set_target_properties(freerdp-client PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/lib/freerdp-client3.lib"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_DEBUG "freerdp"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/freerdp-client3.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS freerdp-client )
list(APPEND _IMPORT_CHECK_FILES_FOR_freerdp-client "${_IMPORT_PREFIX}/lib/freerdp-client3.lib" "${_IMPORT_PREFIX}/lib/freerdp-client3.dll" )
