...
set_target_properties(winpr PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/lib/winpr3.lib"
  IMPORTED_LINK_INTERFACE_LIBRARIES_DEBUG "ntdsapi;crypt32;dbghelp;ws2_32;rpcrt4;credui;shlwapi"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/winpr3.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS winpr )
list(APPEND _IMPORT_CHECK_FILES_FOR_winpr "${_IMPORT_PREFIX}/lib/winpr3.lib" "${_IMPORT_PREFIX}/lib/winpr3.dll" )
...
set_target_properties(winpr-tools PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/lib/winpr-tools3.lib"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_DEBUG "winpr"
  IMPORTED_LINK_INTERFACE_LIBRARIES_DEBUG ""
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/winpr-tools3.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS winpr-tools )
list(APPEND _IMPORT_CHECK_FILES_FOR_winpr-tools "${_IMPORT_PREFIX}/lib/winpr-tools3.lib" "${_IMPORT_PREFIX}/lib/winpr-tools3.dll" )
